...
import liquibase.harness.util.DynamoDBTestUtils
...
class HarnessNoSqlCompatibility extends Specification {
    ...
    def setupSpec() {
        ...
        strategy = DynamoDBTestUtils.chooseRollbackStrategy()
    ...
    def "apply #testInput.change against #testInput.databaseName #testInput.version"() {
        ...
        String basePath = "liquibase/harness/compatibility/foundational/changelogs/dynamodb"
...
//        assert JSONUtils.compareJSONArrays(generatedResultSetArray, expectedResultSetArray, JSONCompareMode.LENIENT)
//
...
//        }
        ...
        testInput << CompatibilityTestHelper.buildTestInput("/dynamodb")
    }
